...
const AnnotationPreset = ({
  ...
  return (
    <div>
      <div className="dark:border-color-dark h-full rounded-lg border border-dashed border-gray-400 p-2">
        <form className="flex flex-col gap-[2px]">
          <div className="flex justify-between">
            <div className="flex gap-2">
              ...
              <APSelect
                ...
                editFieldInPreset={editFieldInPreset}
              />
              {/* color */}
              <APColor
                annotationPreset={annotationPreset}
            ...
            <div className="flex flex-row gap-1">
              <button
                title="Copy preset"
                type="button"
                onClick={() => copyPresetHandler(annotationPreset.id)}
                className="default-button-bg-border btn btn-square btn-sm"
              >
                <Image
              ...
              <button
                title="Delete preset"
                type="button"
                onClick={() => removePresetHandler(annotationPreset.id)}
                className="default-button-bg-border btn btn-square btn-sm"
              >
                <Image
                  className="dark:svg-filter-dark"
          ...
          <APTextFields
            annotationPreset={annotationPreset}
            removeTextField={removeFieldHandler}
            editFieldInPreset={editFieldInPreset}
          />
        </form>
        <APNewField
          annotationPreset={annotationPreset}
          addTextField={addNewFieldHandler}
        />
      </div>
    </div>
  );
